...
const Output = () => {
    ...
    const upload = () => {
        ...
        axios.post('https://thaiidback.onrender.com/upload' , formData)
        .then(res => {
      ...
      const analyse = async () => {
        try {
          const uri = `https://thaiidback.onrender.com/api/users/${id}`;
          // console.log(id , uri)
  ...
  return (
    <>
      ...
      <div className="par">
        <div className="img">
          <img src = {'https://thaiidback.onrender.com/Images/' + image} alt=""/>
        </div>
        <div className="items">
          {okstate === "OK" ? (
            <div>
